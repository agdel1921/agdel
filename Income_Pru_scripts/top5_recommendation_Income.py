...
#   1.
### CSV file indicating the TOP 5 on-shelf products each customer is likely to be interested in
...
pathInp_trained = pd.read_csv(pathInp_reco + "pd_weighted_recommended_noHealth_tmp1.csv", low_memory = True)
...
if __name__ == "__main__":
    ...
    """
    generate_overall_recommendations(6, 0.2)
