...
"""
## Cross Check means using Method 1 for training purposses and Validation set is from Method2(transaction march 2016 onwards)
...
#                    print(prod_purchased)
    ...
    match_results_Pd.to_csv(pathOp_merged+match_method+"_accuracy_CrossCheck.csv", header=True, index=False)
...
#    newSalesPd = nb_Pd[nb_Pd["batctrcde"]!="B522"]
    ...
    merged_reco_nb_Pd.to_csv(pathOp_merged+ 'merged_pd__crossCheck.csv', header = True, index = False)
