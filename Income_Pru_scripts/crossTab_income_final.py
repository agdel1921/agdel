...
df_Fin_tran = pd.read_csv(pathread + "final_data_temp_recom.csv", low_memory = True)
df_Fin_tran.columns
...
amgPd = pd.read_csv(pathread+'data_merge.csv', low_memory = True)
amgPd.columns
print (amgPd.shape)
amgPd.head()
...
amgPd.columns = ['hid', 'customerseqid', 'customerstatus', 'genderph', 'policyseqid',
       ...
       'productsubcategory', 'ismain', 'Category_list', 'Category_count']
