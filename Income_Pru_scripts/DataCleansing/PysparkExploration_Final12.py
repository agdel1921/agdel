...
def data_exploration(data,data_name):
    ...
    categorical_output_loc = r"D:\NTUC\Processed\categorical_output_" + data_name + ".csv"
    descriptive_output_loc = r"D:\NTUC\Processed\desc_output_" + data_name + ".csv"
    for column in data.schema.names:
        graph_name=r"D:\NTUC\Processed\categorical_output_" + data_name + "_" + column + ".png"
