...
path_op = "/home/latize/Downloads/JPN/contracts/" 
...
inpFileLst = ['PRODUCT.csv', 'SKU.csv', '4_COMPONENT.csv', '13_INSURER.csv', '17_MODEL.csv', '14_MFG.csv', '21_PRODUCT_CLASS_COLLECTION.csv', '22_PRODUCT_CLASS_SECTION.csv', '23_PRODUCT_COVERAGE.csv', '26_SERVICE_LOCATION.csv', '29_WRITING_COMPANY.csv', 'SKU.csv', '8_COVERAGE_TYPE.csv', '20_PRICE_RATING_METHOD.csv' ]
...
inputFile1.columns = list(schema.Column_names)
