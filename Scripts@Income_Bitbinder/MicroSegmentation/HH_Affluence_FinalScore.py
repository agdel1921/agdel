# -*- coding: utf-8 -*-
"""
Created on Sat Nov 24 13:27:51 2018
...
#path defination
path3 = "E:/NTUC/raw_data/HOUSE_HOLD_FINAL/Premium_buckets.csv"
path = "E:/NTUC/raw_data/HOUSE_HOLD_FINAL/HouseHold_FinalData.csv"
...
veht.columns
# PremiumScore
#result = df.merge(df1, on='hid', how ='left'  )
#result.columns

result = df3.merge(df1, on='premiumbucket', how ='left'  )
result.columns
