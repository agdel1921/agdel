        ...
        for s1 in range(len(ranges.index)):
            ...
            for y in typ:
                ...
                if type(y)!=str:
                    ...
                    if str(x)!="subClassOf":
                        if "Data" in prp:
                            print "latize:"+x[:1].lower()+x[1:]+prp," ;"
                            print "    rdfs:range ",y+" ;"
                            dmn =""            
                            for z1 in o:
                            ...
                            print "latize:"+x+"rdf:type "+"owl:DatatypeProperty;"
                        ...
                        if y not in ranges.columns:
                            if y not in parentClass:
                                print "latize:"+y + "rdf:type"+"owl:Class ;"
                                print "    rdfs:label '" +y+"'. \n\n"
                                parentClass.append(y)
                        for z1 in o:
                            dmn=""
                            dmn = dmn + 'latize:'+z1[:1].title()+z1[1:]
                            print dmn +"rdf:type"+ "owl:Class ;"
            ...
            for y in typ:
                ...
                if type(y)!=str:
                    ...
                    if ("xsd:" ==y[:4]):
                        ...
                        prp = "rdf:type "+"owl:ObjectProperty"
                    if str(x)!="subClassOf":
                        if "Data" in prp:
                            print >>f, "###  http://data.latize.com/vocab/"+x+"\n" 
                            print >>  f, "latize:"+x+" rdf:type "+prp," ;"
                            ...
                            print >>  f, objSplit[0][:7]+objSplit[0][7:8].lower()+objSplit[0][8:]+" a "+prp," ;"
                            ...
                            print >>  f, '    rdfs:label "'+rev(x)+ '" .\n\n'
                            # now print the Data Type Property for the column
                            print >>  f, "latize:"+x+" rdf:type: "+" owl:DatatypeProperty;"
                        ...
                        if y not in ranges.columns:
                            if y not in parentClassPrint:
                                ...
                                print >>  f, "latize:"+y +" rdf:type "+ " owl:Class ;"
                        ...
                        for z1 in o:
                            ...
                            print >>  f,  dmn + " rdf:type "+"  owl:Class ;"
